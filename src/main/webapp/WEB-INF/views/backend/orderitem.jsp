		...
		<div class="context">
			<form action="<c:url value="/pages/orderitem.controller" />"
				...
				<table>
					...
					<tr>
						<td>首圖 :</td>
						<td><input type="text" name="picmain" value="${param.picmain}"></td>
					...
					<tr>
						<td><input type="submit" name="orderitemction" value="Update"></td>
						<td><input type="submit" name="orderitemction" value="Delete"></td>
