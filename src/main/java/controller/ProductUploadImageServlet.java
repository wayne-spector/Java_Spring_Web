...
@MultipartConfig(location = "C:\\JavaFramework\\eclipse-workspace\\labweb-topic-final-test\\src\\main\\webapp\\upload")
...
//接收資料
		...
		while (parameterNames.hasMoreElements()) {
			...
			String temp1 = request.getParameter(tempt);
			System.out.println("引數名：" + tempt + "\t" + "結果：" + request.getParameter(tempt));
		}
...
//		}
		...
		String fname = "";
		String picUrl = "C:\\JavaFramework\\eclipse-workspace\\labweb-topic-final-test\\src\\main\\webapp\\upload\\";
		int i = 0;
